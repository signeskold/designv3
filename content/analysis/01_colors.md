...
<br>
<img src="%assets_url%/img/analysis/ikea_header.webp" alt="IKEA header" width="100%">
...
<br>
<img src="%assets_url%/img/analysis/ikea_3items.webp" alt="IKEA items" width="100%">
Bild 2: ikea.dk, Bildtexter med matchande bakgrundsfärg.

<br>
<img src="%assets_url%/img/analysis/ikea_footer.webp" alt="IKEA footer" width="100%">
...
<br>
<img src="%assets_url%/img/analysis/ikeacom_footer.webp" alt="IKEA com" width="100%">
...
<br>
<img src="%assets_url%/img/analysis/cdon_header.webp" alt="CDON header" width="100%">
Bild 5: cdon.se, sidhuvud.

<br>
<img src="%assets_url%/img/analysis/cdon_footer.webp" alt="CDON footer" width="100%">
...
En annan av de större aktörerna inom den svenska e-handeln är Dustin. De erbjuder
...
flera till antalet. Dustin Home har, precis som CDON, en extra list i sidhuvudet.
...
<br>
<img src="%assets_url%/img/analysis/dustin_header.webp" alt="Dustin header" width="100%">
...
<br>
<img src="%assets_url%/img/analysis/dustin_footer.webp" alt="Dustin footer" width="100%">
